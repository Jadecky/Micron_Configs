...
make flash FLASH_DEVICE=/dev/serial/by-id/usb-CanBoot_stm32f446xx_25004D000F50535556323420-if00 KCONFIG_CONFIG=klipper-bigtreetech-octopus.config
...
make flash FLASH_DEVICE=/dev/serial/by-id/usb-CanBoot_stm32g0b1xx_40004B001750425539393020-if00 KCONFIG_CONFIG=klipper-btt-ebb36-v1.2.config
